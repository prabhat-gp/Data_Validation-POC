...
DEMO = {
    "Account": {
        ...
        "fields": [
            ...
            ("Type",              "Integrity"   ,  12100, "CRITICAL"),
            ("BillingCountry",    "Integrity"    , 9900,  "CRITICAL"),
            ("Name",              "Uniqueness",    7700,  "WARNING"),
            ("Phone",             "Validity",        6600,  "WARNING"),
            ("Industry",          "Validity",      4400,  "WARNING"),
            ("BillingPostalCode", "Validity",        2750,  "WARNING"),
            ("Website",           "Validity",        3300,  "WARNING"),
        ],
    },
    "Contact": {
        "rows": 90000,
        "fields": [
            ...
            ("AccountId",       "Integrity"    , 16200, "CRITICAL"),
            ("MailingCountry",  "Integrity"   ,  12600, "WARNING"),
            ("Email",           "Uniqueness",    4500,  "WARNING"),
            ("Phone",           "Validity",        9000,  "WARNING"),
    ...
    "Product": {
        ...
        "fields": [
            ...
            ("ProductCode",            "Integrity"    , 3600, "WARNING"),
            ("Family",                 "Integrity"   ,  4500, "WARNING"),
            ("ProductCode",            "Uniqueness",    900,  "WARNING"),
            ("Description",            "Validity",        5400, "WARNING"),
    ...
    "Account Team": {
        ...
        "fields": [
            ...
            ("AccountId",          "Integrity"    , 4000, "WARNING"),
            ("TeamMemberRole",     "Integrity"   ,  2800, "WARNING"),
